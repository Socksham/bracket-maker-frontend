...
export const localPlayingBracketSlice = createSlice({
  name: "localPlayingBracket",
  initialState: {
    bracket: {rounds: [
      {
        title: "Round of 16",
  ...
  reducers: {
    updateLocalPlayingBracket: (state, action) => {
...
export const { updateLocalPlayingBracket } = localPlayingBracketSlice.actions;

export default localPlayingBracketSlice.reducer;
